...
import step4.AddressBookProtos.Person;

/**
 * Created by ibenian on 3/11/17.
 *
 * Compare messages using equals().
 *
 */
public class TestApp {
    ...
    public static void main(String[] args) {
        ...
        Person.Builder builder2 = john.toBuilder();   // Any changes made by builder2 won't affect john.

        Person jane0 = builder2.build();        // Build jane before making any changes

        builder2.setName("Jane Doe");           // Does this change jane0?
        System.out.printf("Has jane0 been modified by the builder2? %s\n", jane0.getName());
        ...
        System.out.printf("Has john's name change after Jane is updated? %b\n", john.getName().equals(jane.getName()));
        ...
        System.out.printf("Is john's contents same as jane0? %b\n", john.equals(jane0));
        System.out.printf("Is john's contents same as jane? %b\n", john.equals(jane));
        System.out.printf("Is jane's contents same as jane0? %b\n", jane.equals(jane0));
    }
}
