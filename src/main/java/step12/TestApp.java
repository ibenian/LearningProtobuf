...
import step12.AddressBookProtos.Person;

/**
 * Created by ibenian on 3/11/17.
 *
 * Remove an existing field and added a new field with a new index (Backward compatibility is maintained)
 *
 */
public class TestApp {
    ...
    public static void main(String[] args)
        ...
        step12v2.AddressBookProtos.Person john2 = step12v2.AddressBookProtos.Person.parseFrom(buffer);
